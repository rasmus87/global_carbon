...
dens <- read_csv("../predict_density/builds/3_densities_post.pred.csv")
...
mean_CC <- mean(45.01, 45.64, 46.85, 47.88)
mean_SD_CC <- mean(5.23, 4.95, 3.98,  3.49)
C_per_DM <- mean_CC/100
...
ME.samples <- ME.samples / C_per_DM.samples # kJ / (kgC/kgDM)
##############
